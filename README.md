...
- [ ] **Controle de Estoque** Baixa automática de estoque após a compra e sinalização visual de "Esgotado".
- [ ] **Gestão de Pedidos:** Painel (Dashboard) para visualizar status (Pendente → Enviado) e dados do comprador.

### 🛒 Módulo do Cliente (Storefront)
- [ ] **Catálogo de Produtos:** Visualização detalhada dos cafés.
