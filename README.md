...
- [ ] **Categorização:** Organização dos produtos por tipo.
- [ ] **Controle de Estoque** Baixa automática de estoque após a compra.
- [ ] **Gestão de Pedidos:** Painel (Dashboard) para visualizar status e dados do comprador.

### 🛒 Módulo do Cliente (Storefront)
- [ ] **Catálogo de Produtos:** Visualização detalhada dos produtos.
